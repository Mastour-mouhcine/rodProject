...
<body id="page-top">
   ...
   <script  >
        $(document).ready(function() {
            const seg1 = localStorage.getItem('Result_Seg_1');
            const seg2 = localStorage.getItem('Result_Seg_2');
            const seg3 = localStorage.getItem('Result_Seg_3');
            const seg4 = localStorage.getItem('Result_Seg_4');
            const seg5 = localStorage.getItem('Result_Seg_5');
            const seg6 = localStorage.getItem('Result_Seg_6');
            const seg7 = localStorage.getItem('Result_Seg_7');
            var table=	$('#DataTable_segment').DataTable( {
                ...
                columnDefs: [
                    ...
                    order: [[ 1, 'asc' ]],
                    "ajax" : {
                        "url":"serverSide/SrvS_Data_acheteurByActif.php?var_seg1="+seg1+"&var_seg2="+seg2+"&var_seg3="+seg3+"&var_seg4="+seg4+"&var_seg5="+seg5+"&var_seg6="+seg6+"&var_seg7="+seg7,
                        dataSrc : ""
                    },
                    fixedColumns:   {
                        left: 1,
            ...
            $('#Btn_suivant').click( function () {
                window.open("index_ciblage_actif.php", '_self');
            } );
        } );
