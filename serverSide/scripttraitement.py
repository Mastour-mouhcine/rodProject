...
mycursor1.execute("SELECT * INTO input1_test FROM data_input_test LEFT JOIN code_postaux_test ON data_input_test.code_postal= code_postaux_test.[CODE POSTAL2] WHERE data_input_test.[mail_status]='Valid';")
mydb.commit()
...
mycursor1.execute("ALTER TABLE input3_test ADD TelDerect varchar(max) ")
mycursor1.execute("ALTER TABLE input3_test ADD Mandataire varchar(max)")
mycursor1.execute("UPDATE input3_test SET TelDerect=IIF(telephone IS NOT NULL ,CONCAT('+',telephone),telephone)")
mycursor1.execute("ALTER TABLE input3_test ADD Description varchar(max)")
