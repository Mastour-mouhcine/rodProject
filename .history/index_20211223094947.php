...
<html>
    ...
    <body>
        ...
        <div class="field-group">
            ...
            <div><input name="member_name" type="text" value="<?php if(isset($_COOKIE["member_login"])) { echo $_COOKIE["member_login"]; } ?>" placeholder="Entrer le nom d'utilisateur" class="input-field">
        </div>
        <div class="field-group">
            <div><label for="password">Password</label></div>
            <div><input name="member_password" type="password" value="" placeholder="Entrer le mot de passe" class="input-field"> 
        </div>
        <div class="field-group">
