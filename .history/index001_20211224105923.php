...
<body style="background-image: url('/img/HOME.jpeg'); background-size: cover; display: flex; flex-direction: column;">
    <div>
        <div class="card-footer" style="display: flex;justify-content: right;background: transparent;border-style: none!important;"><a href="serverSide/LogOut.php" class="btn btn-success" style="background-color: #D3D9E4;">Déconnecter</a></div>
