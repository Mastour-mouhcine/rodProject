...
<body style="background-image: url('/img/HOME.jpeg'); background-size: cover; display: flex; flex-direction: column;">
    ...
    white-space: nowrap;display: flex;">
        <img src="img/RODSCHINSON_LOGO_Big_Positif_1500x818px.png" style="width: 17rem; padding: 1rem; float: left;"/>
        <div class="card-footer" style=" float: right;justify-content: right;background: transparent;border-style: none!important;font-weight: bold;"><a href="serverSide/LogOut.php" class="btn btn-success" style="background-color: #D3D9E4; color:black">Déconnecter</a></div>
    </div>
    <div  style=" display: flex; justify-content: center; flex-direction: column; align-items: center; background: transparent">
        <div style= "justify-content: center; flex-direction: column; align-items: center; background: transparent">
            <button  onclick="window.location.href='index_Input.php'" class="button button1"><span class="button-content"> <i class="fas fa-database"></i> Marketing(Phingoo)</span></button>
            <button onclick="window.location.href='dataRodschinson.php'"  class="button button2"> <i class="fas fa-database"></i> Operations Data</button>
        ...
        <div style=" justify-content: center; flex-direction: column; align-items: center; background: transparent">
            <button onclick="window.location.href='dataRodschinson001.php'"  class="button button2"><i class="fas fa-database"></i>  Data Rod All</button>
        ...
        <div style=" justify-content: center; flex-direction: column; align-items: center; background: transparent">
            <button onclick="window.location.href=''" class="button button6"> <i class="far fa-envelope"></i>Targeting List</button>
            <button onclick="window.location.href=''" class="button button7"> <i class="fas fa-chart-line"></i>Prospection</button>
        </div> 
