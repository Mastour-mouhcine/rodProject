                                ...
                                <tr>
                                    <td>
                                        <select class="custom-select" id="seg-1-choice">
                                            <option selected="" style="display: none">0-500$</option>
                                            <option value="e">Open menu</option>
                                            <option value="0-500">0-500</option>
                                        </select>
                                    </td>
                                    <td>
                                        <select class="custom-select" id="seg-2-choice">
                                            <option selected="" value="e">Open menu</option>
    ...
    <script  >
        $(document).ready(function() {
            ...
            $('#clear-choices').on("click", function () {
                $('#seg-1-choice').prop('selectedIndex', 0);
                $('#seg-2-choice').prop('selectedIndex', 0);
                $('#seg-3-choice').prop('selectedIndex', 0);
                $('#seg-4-choice').prop('selectedIndex', 0);
                $('#seg-5-choice').prop('selectedIndex', 0);
                $('#seg-6-choice').prop('selectedIndex', 0);
                $('#seg-7-choice').prop('selectedIndex', 0);
                seg_1_col = 'e';
                seg_2_col = 'e';
                seg_3_col = 'e';
                seg_4_col = 'e';
            ...
            $('#Btn_selected').click( function () {
                ...
                if($('#seg-2-choice :selected').text() == '500-1000'){
                    string_segment += "'"+$('#seg-2-choice').find(":selected").text()+"',";
                }
                if($('#seg-3-choice :selected').text() == '1000-2000'){
