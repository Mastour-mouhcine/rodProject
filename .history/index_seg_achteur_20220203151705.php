            ...
            <div class="container-fluid" style="margin-top: 2rem">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" id="">
                        <div class="card-body" style=" display: flex; justify-content: center; flex-direction: column; align-items: center; background: transparent">
                          
                                    <button type="button" class="btn btn-success" id="clear-choices">Clear Choices</button>
...
var table=	$('#import_zoho_contact1').DataTable( {
    ...
    var seg_3_col = 'e';
    /* 
    var conceptName = $('#seg-1-choice').find(":selected").text();
