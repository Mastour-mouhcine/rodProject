...
var table=	$('#import_zoho_contact1').DataTable( {
  ...
  stateDuration:-1 ,
    ...
    const { 0: segmentation, 1: secteur,  } = segmentationDataResults
...
const JSalert = (status, message, type) => {
   ...
   $("#Btn_Truncate").click(function (e) {
            ...
            const segmentationData = JSON.parse(localStorage.getItem('segmentationData'));
                const { 0: segmentation, 1: secteur,  } = segmentationData
