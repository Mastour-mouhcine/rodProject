            ...
            <div class="container-fluid" style="margin-top: 2rem">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" id="x">
                        <!-- Ici le lien -->
                        <iframe width="1400" height="800" frameborder="0" scrolling="no" src="https://chikhi.sharepoint.com/_layouts/15/Doc.aspx?sourcedoc={600834d9-190d-41a9-a35f-73d115853338}&action=embedview&ActiveCell='Dashboard'!A1&wdHideGridlines=True&wdHideHeaders=True&wdInConfigurator=True"></iframe>
                    </div>
                </div>
            </div>
        </div>
