...
<body style="background-image: url('/img/HOME.jpeg'); background-size: cover; display: flex; flex-direction: column;">
    <div>
        ...
        <div class="card-footer" style="display: flex;justify-content: right;background: #ffffff40""><a href="serverSide/LogOut.php" class="btn btn-success">Déconnecter</a></div>
    </div>
