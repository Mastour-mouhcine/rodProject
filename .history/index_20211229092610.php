...
<html>
    ...
    <form action="serverSide/verification.php" method="POST" style="border-radius: 20px;opacity: 75%;">
        ...
        <div class="field-group">
            <div><label for="login" style="font-weight: 550;">Username</label></div>
        ...
        <div class="field-group">
            <div><label for="password" style="font-weight: 550;">Password</label></div>
        ...
        <div class="field-group">
            <div style="align-items: center;display: flex;justify-content: center;"><input type="submit" id='submit' name="login" value="LOGIN" class="form-submit-button" style="border-radius: 10px; width:50%;"></span></div>
        </div>   
                <?php
