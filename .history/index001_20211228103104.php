...
<body style="background-image: url('/img/HOME.jpeg'); background-size: cover; display: flex; flex-direction: column;">
    <div style="width: 100%;overflow: hidden;white-space: nowrap;display: flex;">
        ...
        <div class="card-footer" style="margin-left: auto; margin-right: 0;justify-content: right;background: transparent;border-style: none!important;"><a href="serverSide/LogOut.php" class="btn btn-success" style="background-color: #D3D9E4; color:black;font-weight: 520;">Déconnecter</a></div>
    </div>
