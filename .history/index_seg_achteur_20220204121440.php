                    ...
                    <div class="card shadow mb-4">
                        ...
                        <table id="selections_seg" style="width:60%">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <input type="checkbox" id="scales" name="scales" value="0-500">
                                        <label>0-500$</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" id="scales" name="scales" value="500-1M">
                                        <label>500$-1M$</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" id="scales" name="scales" value="1M-2M">
                                        <label>1M$-2M$</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" id="scales" name="scales" value="2M-5M">
                                        <label>2M$-5M$</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" id="scales" name="scales" value="5M-10M">
                                        <label>5M$-10M$</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" id="scales" name="scales" value="10M-40M">
                                        <label>10M$-40M$</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" id="scales" name="scales" value="40M >">
                                        <label>40M$ ></label>
                                    </td>
                                </tr>
                            </tbody>
