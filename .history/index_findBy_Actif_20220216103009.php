   ...
   <script  >
        $(document).ready(function() {
            ...
            $('#Btn_Enregistrer').click( function () {
                ...
                $.ajax({
                    type: "post",
                    url: "serverSide/insertActif_input",
                    data: {data : Mydata},
                    success: (data) => {
            ...
            $('#Btn_suivant').click( function () {
                let string_segment_1 = '';
                let string_segment_2 = '';
                let string_segment_3 = '';
                let string_segment_4 = '';
                let string_segment_5 = '';
                let string_segment_6 = '';
                let string_segment_7 = '';
                if($('#seg-1-choice:checked').is(':checked')){
                    string_segment_1 = " Segment_1 in(1) ";
                }
                if($('#seg-2-choice:checked').is(':checked')){
                    string_segment_2 = " Segment_2 in(1) ";
                }
                if($('#seg-3-choice:checked').is(':checked')){
                    string_segment_3 = " Segment_3 in(1) ";
                }
                if($('#seg-4-choice:checked').is(':checked')){
                    string_segment_4 = " Segment_4 in(1) ";
                }
                if($('#seg-5-choice:checked').is(':checked')){
                    string_segment_5 = " Segment_5 in(1) ";
                }
                if($('#seg-6-choice:checked').is(':checked')){
                    string_segment_6 = " Segment_6 in(1) ";
                }
                if($('#seg-7-choice:checked').is(':checked')){
                    string_segment_7 = " Segment_7 in(1) ";
                }
                localStorage.setItem("Result_Seg_1", JSON.parse(JSON.stringify(string_segment_1))); 
                localStorage.setItem("Result_Seg_2", JSON.parse(JSON.stringify(string_segment_2))); 
                localStorage.setItem("Result_Seg_3", JSON.parse(JSON.stringify(string_segment_3))); 
                localStorage.setItem("Result_Seg_4", JSON.parse(JSON.stringify(string_segment_4))); 
