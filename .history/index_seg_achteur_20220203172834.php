                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" id="">
                        <div class="card-body" >
                                    ...
                                    <div class="dropdown">
                                    <button type="button" class="btn btn-success" id="seg">Les Segments</button>
...
var table=	$('#import_zoho_contact1').DataTable( {
    ...
    var seg3_option = '';
    /* 
    var seg1_option = "'"+$('#seg-1-choice').find(":selected").text()+"'";
                        console.log(seg1_option); */
    ...
    $('#seg-3-choice').on("change", function () {
                ...
                $.fn.dataTable.ext.search.push(function( settings, searchData, index, rowData, counter ) {
                    if (searchData[seg_1_col] === '0-500') {
                        return true;
                    }
                    if (searchData[seg_2_col] === '500-1000') {
                        return true;
                    }
                    if (searchData[seg_3_col] === '1000-2000') {
                        return true;
                    }
                    if (seg_1_col === 'e' && seg_2_col === 'e' && seg_3_col === 'e') {
                        return true;
                    }
                    return false;
                });
    ...
    $('#Btn_selected').click( function () {
        ...
        if($('#seg-1-choice :selected').text() == '0-500'){
            seg1_option = "'"+$('#seg-1-choice').find(":selected").text()+"',";
            string_segment += seg1_option;
        }
        if($('#seg-2-choice :selected').text() == '500-1000'){
            seg2_option = "'"+$('#seg-2-choice').find(":selected").text()+"',";
            string_segment += seg2_option;
        }
        if($('#seg-3-choice :selected').text() == '1000-2000'){
            seg3_option = "'"+$('#seg-3-choice').find(":selected").text()+"',";
            string_segment += seg3_option;
        }
        var jsarray = [string_segment.slice(0, -1)];
        sessionStorage.setItem("jsAaarray", JSON.stringify(jsarray));
        const segmentationDataResults = JSON.parse(localStorage.getItem('jsAaarray'))
         console.log(segmentationDataResults); 
    } );
} );
