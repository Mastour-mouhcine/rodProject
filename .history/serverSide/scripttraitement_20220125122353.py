...
mycursor1.execute("SELECT * INTO input1_test FROM data_input_test LEFT JOIN code_postaux_test ON data_input_test.code_postal= code_postaux_test.[CODE POSTAL2] WHERE data_input_test1.[mail_status]='valid';")
mydb.commit()
