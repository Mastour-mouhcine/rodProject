...
mycursor1.execute("SELECT  Salutation , [Salutation Emails],[First Name],[Last Name],[Preferred Language],Mobile,Phone,Email,[Other Street],[Other Zip],[Other City],[Province (BE)],[Account Name],[Account Number],[Billing Street],[Billing Code],[Billing City],[Billing Province (BE)],DISTINCT [Phone (Account)] AS [Phone (Account)],[Lead status],Acheteur,Vendeur,[Prospect Source],[Converting Agent],[Source list name],[Vendor Assessment Notes],[New Import],[Contact Owner],[Business Finder Name],[Home Phone],[Secondary Email],Telephone,Mandataire,[Mail du commentaire],Description INTO Import_Zoho_all_test FROM input3_test ")
mycursor1.execute("SELECT  Salutation , [Salutation Emails],[First Name],[Last Name],[Preferred Language],Mobile,Phone,Email,[Other Street],[Other Zip],[Other City],[Province (BE)],[Account Name],[Lead status],Acheteur,Vendeur,[Prospect Source],[Converting Agent],[Source list name],[Vendor Assessment Notes],[New Import],[Contact Owner],[Business Finder Name],[Home Phone],[Secondary Email],DISTINCT Telephone AS Telephone,Mandataire,[Mail du commentaire],Description INTO Import_Zoho_Contact_test FROM input3_test ")
