...
class SSP {
	...
	static function sql_connect ( $sql_details )
	{
		...
		// 	);
		// }
        throw new Exception($db = @new PDO("odbc:Driver={$sql_details['driver']};Server={$sql_details['host']};Database={$sql_details['db']}",$sql_details['user'],$sql_details['pass'],array( PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION )));
