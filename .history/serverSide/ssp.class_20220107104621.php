...
class SSP {
	...
	static function simple ( $request, $sql_details, $table, $primaryKey, $columns ) {
		...
		throw new Exception("SET NOCOUNT ON SELECT count({$primaryKey}) FROM $table $where ORDER BY {$primaryKey}");
	  // Data set length after filtering  the $where will update info OR will be blank when not doing a search
		...
		$resFilterLength = self::sql_exec( $db, $bindings,"SET NOCOUNT ON SELECT count({$primaryKey}) FROM $table $where ORDER BY {$primaryKey}" );
		//$recordsFiltered = count($resFilterLength);
