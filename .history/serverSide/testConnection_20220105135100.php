...
try {
    $conn = new PDO("odbc:Driver={ODBC Driver 13 for SQL Server};server = tcp:rods-data-server-01.database.windows.net,1433; Database = Data_Rods", "admin-rods", "roods-pwd@1");
