...
for i in range(length):
    if liste1[i][1]=='French':
        if liste1[i][7]is not None or liste1[i][7] is not Empty :
...
for i in range(length):
    if liste2[i][1]=='French':
        if liste2[i][7]is not None or liste2[i][7] is not Empty:
            subject='Suite à l\'échange téléphonique'
...
for i in range(length):
    if liste3[i][1]=='French':
        if liste3[i][7]is not None or liste3[i][7] is not Empty:
