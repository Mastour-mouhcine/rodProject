...
mycursor1.execute("SELECT UNIQUE [Province (BE)],[Account Name],[Account Number],[Billing Street],[Billing Code],[Billing City],[Billing Province (BE)],[Phone (Account)],[Contact Owner] INTO Import_Zoho_Compte_test FROM input3_test")
