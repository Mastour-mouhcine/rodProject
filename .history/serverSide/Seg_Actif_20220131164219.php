<?php
 ...
 //Establishes the connection
    ...
    [Secteur ordre dans liste2],[SECTEUR FR],[SECTEUR NL],[REGLE LC],[BROKERS CONSIGNE],[stop],[DESCRIPTION FR],
    [DESCRIPTION NL],[DESCRIPTION EN],[detail FR],[detail NL],[BLACKLIST],[NOM DOSSIER],[COMPTE],[VAT],[CLIENT],
    [MAIL],[MAIL2],[GSM],[TEL],[TEL2],[DURÉE CONTRAT (MOIS)],[DEBUT CONTRAT],[FIN CONTRAT],[TYPE CONTRAT],[% COMISSION],
    [LANGUAGE],[Gmaps],[WHISE],[WHISE OK],[mot clé],[TITRE ZOHO SELECT],[dans zoho select],[CIBLAGE RENDEMENT],
    [CIBLAGE PROMOTION],[GROS],[CIBLAGE],[ciblage prox],[Remarques ],[Date],[Gestionnaire de compte ],
    [PUBLICATION RESEAUX SOCIAUX],[BN] FROM [dbo].[Actifs_test] $string_seg $string_sect $string_brand";
