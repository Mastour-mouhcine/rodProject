            ...
            <div class="container-fluid" style="margin-top: 2rem">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3" style="display: flex; justify-content: space-between; align-items: center">
                        <div>
                            <h6 class="m-0 font-weight-bold text-primary">Tableau Actif</h6>
                        </div>
                   ...
                   <!-- Toggle column: <a class="toggle-vis" data-column="0">DIVISION</a> - <a class="toggle-vis" data-column="1">Salutation</a> - <a class="toggle-vis" data-column="2">Salutation</a> - <a class="toggle-vis" data-column="3">Age</a> - <a class="toggle-vis" data-column="4">Start date</a> - <a class="toggle-vis" data-column="5">Salary</a> -->
                        ...
                        <thead>
                                <tr>
                                    ...
                                    <th>WHISE OK</th>
                                    [],[],[],
                                    [],[],[],[ciblage prox],[Remarques ],[Date],[Gestionnaire de compte ],
                                    [PUBLICATION RESEAUX SOCIAUX],[BN]                                   
                                    <th>mot clé</th>
                        ...
                        <div style="display: flex; justify-content: flex-end; align-items: center"> 
                            <div> 
                            <button id="Btn_Truncate" class="btn btn-success" style="margin-top:10%;"> Suivant</button>
                            </div> 
                        </div> 
...
$(document).ready(function() {
    ...
    const { 0: segmentation, 1: secteur, 2: brand, } = segmentationDataResults
...
var table=	$('#import_zoho_contact1').DataTable( {
  ...
  stateDuration:-1 ,
		"ajax" : {
			// "url":"serverSide/Seg_Actif.php?var_segmentation='+seg+'&var_secteur='+sec",
    ...
    // location.href = 'serverSide/Seg_Actif.php?var_segmentation='+seg+'&var_secteur='+sec;
} );
