    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid" style="margin-top: 2rem">
                ...
                <div class="card-body" id="excel_data" style="overflow-x:auto;">
                ...
                <button onclick="location.href='index_Input001.html'" type="button" id="btn_validerMail" class="btn btn-success">ajouter nouvelle source</button>
        </div>
        <!-- End of Main Content -->
