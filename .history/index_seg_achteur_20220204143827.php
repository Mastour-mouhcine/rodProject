        ...
        $(document).ready(function() {
            ...
            $('#Btn_selected').click( function () {
                ...
                if($('#seg-3-choice:checked').val() == '1M-2M'){
                    string_segment += "'"+$('#seg-3-choice').val()+"',";
                }
                if($('#seg-4-choice:checked').val() == '2M-5M'){
                    string_segment += "'"+$('#seg-4-choice').val()+"',";
                }
                if($('#seg-5-choice:checked').val() == '5M-10M'){
                    string_segment += "'"+$('#seg-5-choice').val()+"',";
                }
                if($('#seg-6-choice:checked').val() == '10M-40M'){
                    string_segment += "'"+$('#seg-6-choice').val()+"',";
                }
                if($('#seg-7-choice:checked').val() == '40M >'){
                    string_segment += "'"+$('#seg-7-choice').val()+"',";
                }
