        ...
        $(document).ready(function() {
            ...
            var table=	$('#DataTable_segment').DataTable( {
                ...
                columnDefs: [
                    ...
                    order: [[ 1, 'asc' ]],
                    "ajax" : {
                        "url":"serverSide/SrvS_Data_acheteurByActif.php?var_seg1="+seg1+"&var_seg2="+seg2+"&var_seg3="+seg3+"&var_seg4="+seg4+"&var_seg4="+seg5+"&var_seg5="+seg5+"&var_seg6="+seg6+"&var_seg7="+seg7,
                        dataSrc : ""
                    },
                    fixedColumns:   {
                        left: 1,
