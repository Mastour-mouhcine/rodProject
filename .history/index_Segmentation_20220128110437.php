...
var table=	$('#import_zoho_contact1').DataTable( {
    ...
    //     ],
		...
		columns : [
			{"data":"First Name", className:"fName"},
			{"data":"Last Name", className:"lName"},
			{"data":"Email", className:"mail"},
		],		
	} );
    $('#selections').on('click', function(){
    console.log($('div.dtsp-searchPane table').DataTable().rows({selected: true}).data().toArray());
  })
} );
