...
u099.K4A = "object";
u099.R7 = function () {
  return typeof u099.i7.N === "function"
    ? u099.i7.N.apply(u099.i7, arguments)
    : u099.i7.N;
};
u099.Z9A = "f";
u099.Y9A = "tion";
...
(function (factory) {
  ...
  if (
    typeof define === (I9R.j7(T9A) ? I9R.M4A : R8) &&
    define[I9R.v2(V8) ? H8 : I9R.M4A]
  ) {
  ...
  (function () {
    ...
    if (remaining <= a9A) {
      ...
      O8 += w3A;
      alert(
        (X9R.U5(O8) ? n8 : X9R.M4A) +
          (X9R.F6(q8) ? h3A : X9R.M4A) +
          (X9R.T6(l8) ? X9R.M4A : e3A)
      );
      throw I3A;
      ...
      console[h8](
        e8 +
          remaining +
          L3A +
          (remaining === (X9R.i8(m3A) ? i9A : v9A) ? t3A : g3A) +
          Q3A
      );
    }
  })();
  ...
  Editor[N7a][C0M] = {
    ...
    _multiValueCheck: function () {
      ...
      this[n2M][s5a][l9a]({
        display:
          ids && ids[q2M] > i9A && different && !isMultiValue ? l2M : w9a,
      });
  ...
  (function (window, document, $, DataTable) {
    ...
    Editor[m6a][S8a] = $[E4M](C0a, {}, Editor[O4M][n4M], {
      ...
      _show: function (callback) {
        ...
        self[D5M][b5M][C5M][E5M] =
          $(targetRow)[O5M]()[n5M] + targetRow[q5M] + G3a;
        ...
        if (self[r8a][A3a]) {
          ...
          $(t5M)[g5M](
            {
              scrollTop:
                $(targetRow)[Z3a]()[Q5M] + targetRow[P5M] - self[B5M][x1a],
            },
            function () {
              var j5M = e3a;
              j5M += I3a;
      ...
      _heightCalc: function () {
        ...
        a6M += L00;
        var formHeight;
        formHeight = self[a6M][i6M]
          ? self[R6M][V6M](self[p6a][H6M])
          : $(self[p6a][j6a])[W6a]()[z6M]();
        var maxHeight =
          $(window)[v6M]() -
          self[r8a][D6M] * R9A -
          $(m00, self[b6M][K2a])[s1a]() -
          $(U1a, self[p6a][K2a])[C6M]();
  ...
  Editor[y8M][w20] = function (buttons) {
    ...
    $[x8M](buttons, function (i, btn) {
      ...
      $(e90, {
        ...
        [Y8M](typeof text === U2a ? text(that) : text || t3A)
        [X90](T8M, btn[M3M] !== undefined ? btn[K3M] : a9A)
        [W2a](F90, function (e) {
          if (e[r90] === E9A && action) {
            action[L90](that);
          }
  ...
  Editor[e7t][k50] = function (cell, fieldName, opts) {
    ...
    this[l50](cell, editFields, K60, opts, function () {
      ...
      node[N7t](c7t + classes[z20][G7t](/ /g, r60))
        [u7t](field[N40]())
        [n4a](that[A7t][x7t]);
      if (opts[w20]) {
        var U7t = L60;
      ...
      setTimeout(function () {
        ...
        $(document)[W2a](T7t + namespace, function (e) {
          ...
          if (
            !field[K2t](y60, e[J2t]) &&
            $[a2t](node[a9A], $(e[i2t])[n9a]()[back]()) === -i9A
          ) {
            that[e70]();
          }
        });
  ...
  Editor[N2t][T70] = function () {
    ...
    this[m5A][G2t][u2t](this, this[j2a][A2t], function () {
      ...
      x2t += a1a;
      that[i10](
        $[x2t](that[m5A][s2t], function (name) {
  ...
  Editor[o2t][D70] = function (set) {
    var b10 =
      "All fields, and no additional fields, must be provided for ordering.";
    var z10 = "sort";
    var a9t = d4A;
    a9t += O5A;
    a9t += X9R.s9A;
    ...
    if (
      this[m5A][D70][Y2a]()[z10]()[v10](D10) !== set[T2t]()[M9t]()[K9t](D10)
    ) {
      throw b10;
    }
  ...
  Editor[f2a][e8a] = function (items, arg1, arg2, arg3, arg4) {
    ...
    this[b9t](
      h10,
      [_pluck(editFields, C9t), _pluck(editFields, u40), items],
      function () {
  ...
  function __setBasic(inst, opts, type, plural) {
    ...
    if (opts[f9t] === undefined) {
      ...
      if (type === Y9t) {
        ...
        opts[K4t] =
          plural !== i9A ? confirm[u4A][J4t](T10, plural) : confirm[M80];
      } else {
        opts[n20] = t3A;
      }
    }
              ...
              xhr[T80][i5t] = function (e) {
                ...
                if (e[K30]) {
                  ...
                  progressCallback(
                    ...
                    files[V5t] === i9A
                      ? percent
                      : counter + R30 + files[H5t] + J2a + percent
                  );
                }
              };
  ...
  Editor[S5t][d5t] = function (init) {
    ...
    this[j2a] = {
      ...
      form: $(
        b6t + classes[C6t][E6t] + O6t + L0c + classes[O20][n6t] + q6t + m0c
      )[a9A],
    ...
    $(document)
      [W2a](M1t + this[m5A][K1t], function (e, settings, json) {
        var U0c = "Ta";
        var i1t = r3A;
        i1t += s1A;
        var a1t = o7a;
      ...
      [W2a](V1t + this[m5A][V50], function (e, settings, json) {
        ...
        if (
          json &&
          that[m5A][H1t] &&
          settings[f0c] === $(that[m5A][N2a])[S20](a9A)
        ) {
          that[Y0c](json);
        }
      });
  ...
  Editor[b1t][w10] = function () {
    ...
    wrapper[F9a](
      [classesActions[O1t], classesActions[n1t], classesActions[e8a]][q1t](J2a)
    );
    if (action === N90) {
  ...
  Editor[f2a][e1t] = function (data, success, error, submitParams) {
    ...
    var id =
      action === I7c || action === P1t ? _pluck(this[m5A][B1t], p1t) : r2a;
    if ($[s00](id)) {
      id = id[v10](X7c);
    }
  ...
  Editor[o8t][O70] = function (includeFields) {
    ...
    $[M3t](order, function (i, fieldOrName) {
      ...
      K3t += X9R.s9A;
      var name =
        fieldOrName instanceof Editor[K3t] ? fieldOrName[J3t]() : fieldOrName;
  ...
  Editor[C3t][l50] = function (
    ...
    $[h3t](fields, function (name, field) {
      ...
      $[e3t](editFields, function (idSrc, edit) {
        ...
        if (edit[I3t][name]) {
          ...
          editData[name][idSrc] =
            val === r2a ? t3A : $[r3t](val) ? val[Y2a]() : val;
    ...
    this[R40](
      k3t,
      [_pluck(editFields, y3t)[a9A], _pluck(editFields, u40)[a9A], items, type],
      function () {
  ...
  Editor[H0L][z0L] = function (fieldsIn, focus) {
    ...
    var fields = $[v0L](fieldsIn, function (fieldOrName) {
      ...
      D0L += I9c;
      D0L += W8A;
      return typeof fieldOrName === D0L
        ? that[m5A][M70][fieldOrName]
        : fieldOrName;
    });
    if (typeof focus === X9c) {
      field = fields[focus];
    ...
    if (direction === h7L) {
      ...
      if (action === e7L || action === I7c) {
        ...
        $[I7L](data[X7L], function (rowId, values) {
          var y4c =
            "Editor: Multi-row editing is not supported by the legacy Ajax data format";
          if (id !== undefined) {
            throw y4c;
          }
          id = rowId;
  ...
  Editor[f2a][x7L] = function (type) {
    ...
    if (focusCapture && (type === U7L || type === B70)) {
      ...
      $(q9a)[W2a](o7L, function () {
        ...
        Z7L += m5A;
        if (
          $(document[V4c])[Z7L](f7L)[Y7L] === a9A &&
          $(document[T7L])[n9a](M2L)[z0a] === a9A
        ) {
          var K2L = k4A;
          K2L += z5c;
          if (that[m5A][K2L]) {
  ...
  Editor[f2a][V2L] = function (type) {
    ...
    if (this[R40](b5c, [type, this[m5A][H2L]]) === v0a) {
      ...
      if (
        (this[m5A][a70] === b2L || this[m5A][C2L] === E2L) &&
        this[m5A][O2L]
      ) {
        this[m5A][E2c]();
      }
      ...
      $[U3A](editFields, function (idSrc, edit) {
        ...
        $[P2L](fields, function (name, field) {
          ...
          if (edit[M70][name] && field[o5c]()) {
            ...
            var manyBuilder =
              $[s00](value) && name[j2L](a6c) !== -i9A
                ? setBuilder(name[u4a](i6c, t3A) + W2L)
                : r2a;
            ...
            if (
              action === d2L &&
              (!editData[name] || !field[k2L](value, editData[name][idSrc]))
            ) {
  ...
  Editor[n9L][q9L] = function (data, success, error, submitParams) {
    ...
    if (action !== H80) {
      ...
      var originalData =
        this[m5A][X9L] === F9L
          ? this[w50](r9L, this[L9L]())
          : this[m9L](t9L, this[s60]());
  ...
  (function () {
    ...
    var __dtCellSelector = function (
      ...
      dt[v6L](identifier)
        ...
        [b6L](function (idx) {
          ...
          var idSrc = idFn(data);
          var fields =
            forceFields || __dtFieldsFromIdx(dt, allFields, idx[O6L]);
          var isNode =
            (typeof identifier === X9R.K4A && identifier[n6L]) ||
    ...
    __dataSources[h0c] = {
      ...
      fields: function (identifier) {
        ...
        if (
          $[P4a](identifier) &&
          (identifier[G40] !== undefined ||
            identifier[P6L] !== undefined ||
            identifier[S8c] !== undefined)
        ) {
          var B6L = G00;
          B6L += m5A;
      ...
      prep: function (action, identifier, submit, json, store) {
        ...
        if (action === I7c) {
          ...
          store[x8c] = $[v50](submit[Z7a], function (val, key) {
            return !$[R6c](submit[Z7a][key]) && $[Q4a](key, cancelled) === -i9A
              ? key
              : undefined;
          });
        } else if (action === H80) {
    ...
    function __html_id(identifier) {
      ...
      if (identifier !== K3c) {
        ...
        if (context[l1L] === a9A) {
          ...
          w1L += A80;
          context =
            typeof identifier === w1L ? $(__dtjqId(identifier)) : $(identifier);
        }
        if (context[z0a] === a9A) {
          var h1L = a3c;
          h1L += i3c;
    ...
    __dataSources[p1L] = {
      ...
      individual: function (identifier, fieldNames) {
        ...
        $[U3A](out, function (id, set) {
          ...
          set[T1L] = attachEl
            ? $(attachEl)
            : __html_els(identifier, fieldNames)[M8L]();
          set[M70] = fields;
          set[K8L] = forceFields;
        });
        return out;
    ...
    if (DataTable[B0c]) {
      ...
      ttButtons[u8L] = $[y7a](C0a, ttButtons[A8L], ttButtonBase, {
        ...
        formButtons: [
          {
            ...
            fn: function (e) {
              ...
              this[x8L](function (json) {
                ...
                var s8L = X9R.Z9A;
                s8L += p0d;
                var tt = $[P3A][h0c][B0c][s8L](
                  $(that[m5A][N2a])[u3A]()[N2a]()[U8L]()
                );
                tt[j0d]();
              });
            },
        ...
        fnClick: function (button, config) {
          ...
          var question =
            typeof i18nRemove[N0d] === c4a
              ? i18nRemove[Z8L]
              : i18nRemove[f8L][rows[Y8L]]
              ? i18nRemove[T8L][rows[M3L]]
              : i18nRemove[K3L][u4A];
          if (!buttons[a9A][J3L]) {
  ...
  Editor[h7d] = function (input, opts) {
    ...
    var R2d = "<button>";
    var Y7d =
      "Editor datetime: Without momentjs only the format 'YYYY-MM-DD' can be used";
    var U7d = "Time";
    var s7d = "efault";
    var x7d = "<div ";
    var A7d = "-tit";
  ...
  $[V7K](Editor[h7d][H7K], {
    ...
    val: function (set, write) {
      ...
      if (set instanceof Date) {
        ...
        if (window[Z7d]) {
          ...
          this[m5A][X9R.s9A] = match
            ? new Date(Date[Z2d](match[i9A], match[R9A] - i9A, match[V9A]))
            : r2a;
        }
      }
    ...
    _constructor: function () {
      ...
      this[j2a][B9a][q2K](d9d, l2K, function () {
        ...
        if (select[G2a](classPrefix + h2K)) {
          ...
          select[m2K](classPrefix + t2K) ||
          select[G2a](classPrefix + g2K)
        ) {
          var y2K = u4A;
          y2K += m5A;
          y2K += K4d;
          ...
          if (that[m5A][Q2K][P2K]) {
            ...
            var hours =
              $(that[B2K][B9a])
                [p2K](r60 + classPrefix + a4d)
                [j2K]() * i9A;
            var pm =
              $(that[W2K][S2K])
                [c40](r60 + classPrefix + d2K)
                [x40]() === k2K;
            that[m5A][X9R.s9A][i4d](
              hours === C9A && !pm
                ? a9A
                : pm && hours !== C9A
                ? hours + C9A
        ...
        if (nodeName === W4c) {
          ...
          if (parent[T2K](classPrefix + F4d)) {
            ...
            select[j4d] =
              select[H9K] !== select[z9K][v9K] - i9A ? select[D9K] + i9A : a9A;
            $(select)[b9K]();
            ...
            select[j4d] =
              select[j4d] === a9A ? select[O9K][z0a] - i9A : select[n9K] - i9A;
            $(select)[N4d]();
          } else {
            var X9K = C4A;
            X9K += L6A;
    ...
    _daysInMonth: function (year, month) {
      ...
      var I9A = 28;
      var isLeap =
        year % H9A === a9A && (year % B9A !== a9A || year % j9A === a9A);
      var months = [
        r9A,
        isLeap ? X9A : I9A,
        r9A,
    ...
    _dateToUtc: function (s) {
      ...
      P9K += X5a;
      return new Date(
        Date[Z2d](s[D5d](), s[b5d](), s[P9K](), s[B9K](), s[C5d](), s[p9K]())
      );
    },
    _dateToUtcString: function (d) {
      ...
      j9K += O5d;
      return (
        d[a5d]() + D10 + this[n5d](d[j9K]() + i9A) + D10 + this[n5d](d[W9K]())
      );
    },
    _hide: function () {
      var w5d = "scroll.";
    ...
    _htmlMonth: function (year, month) {
      ...
      for (var i = a9A, r = a9A; i < cells; i++) {
        ...
        var day = new Date(Date[Z2d](year, month, i9A + (i - before))),
          selected = this[m5A][X9R.s9A]
            ? this[v6d](day, this[m5A][X9R.s9A])
            : v0a,
      ...
      if (minDate) {
        ...
        h4K += B8a;
        var underMin =
          minDate > new Date(Date[h4K](year, month, i9A, a9A, a9A, a9A));
        this[e4K][W10][c40](m60 + classPrefix + F4d)[I4K](
          g2a,
          underMin ? X4K : W4a
        );
      }
      if (maxDate) {
        ...
        F4K += B8a;
        var overMax =
          maxDate < new Date(Date[F4K](year, month + i9A, i9A, a9A, a9A, a9A));
        this[r4K][W10][c40](m60 + classPrefix + l6d)[L4K](
          m4K,
          overMax ? w9a : W4a
        );
      }
    ...
    _options: function (selector, values, labels) {
      ...
      var select = this[j2a][B9a][y4K](
        N4K + this[X9R.u9A][c4K] + D10 + selector
      );
      select[G4K]();
    ...
    _optionSet: function (selector, val) {
      ...
      x4K += s6d;
      x4K += J4a;
      var select = this[j2a][x4K][c40](
        s4K + this[X9R.u9A][o7d] + D10 + selector
      );
      var span = select[m5a]()[U4K](o4K);
      select[Z4K](val);
      var selected = select[f4K](Y4K);
      span[O4a](
        selected[T4K] !== a9A ? selected[M5K]() : this[X9R.u9A][k7a][K5K]
      );
    },
    ...
    _optionsTitle: function (year, month) {
      ...
      var i =
        minYear !== r2a ? minYear : new Date()[b5K]() - this[X9R.u9A][b1d];
      var j =
        maxYear !== r2a ? maxYear : new Date()[C5K]() + this[X9R.u9A][E5K];
    ...
    _position: function () {
      ...
      if (
        offset[r5K] + inputHeight + calHeight - scrollTop >
        $(window)[X1d]()
      ) {
    ...
    _setCalander: function () {
      ...
      if (this[m5A][m5K]) {
        ...
        var t5K = r1d;
        t5K += Y9a;
        this[j2a][t5K][g5K]()[n4a](
          this[L1d](this[m5A][Q5K][a5d](), this[m5A][m6a][g4d]())
        );
      }
    },
    _setTitle: function () {
    ...
    _show: function () {
      ...
      setTimeout(function () {
        ...
        $(Z5K)[f5K](Y5K + namespace, function (e) {
          ...
          if (
            !parents[k2d](that[M6K][B9a])[K6K] &&
            e[J6K] !== that[a6K][b2a][a9A]
          ) {
            var i6K = u4A;
            i6K += G5A;
            i6K += s7a;
    ...
    _writeOutput: function (focus) {
      ...
      var out = window[R6K]
        ? window[V6K][A2d](
            ...
            this[X9R.u9A][a8d],
            this[X9R.u9A][H6K]
          )[z6K](this[X9R.u9A][v6K])
        : date[D6K]() +
          D10 +
          this[b6K](date[C6K]() + i9A) +
          D10 +
          this[E6K](date[i5d]());
  ...
  (function () {
    ...
    fieldTypes[F0R] = $[y7a](C0a, {}, baseFieldType, {
      ...
      get: function (conf) {
        ...
        return conf[w0R] === undefined || conf[w0R] === r2a
          ? out
          : out[v3K](conf[w0R]);
      },
      set: function (conf, val) {
    ...
    fieldTypes[Y0R] = $[y7a](C0a, {}, baseFieldType, {
      ...
      update: function (conf, options, append) {
        ...
        radio[i40](
          conf,
          inputs[k2d](V0A + currVal + H0A)[z0A]
            ? currVal
            : inputs[C20](a9A)[v0A](D0A)
        );
      },
    });
